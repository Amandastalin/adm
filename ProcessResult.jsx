        ...
        <div lang="pt-BR" data-theme="light">
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="info-card mb-8">
                    ...
                    <div className="grid gap-4">
                        <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-4">
                            <span className="text-gray-600 dark:text-gray-400">Data da Análise Final:</span>
                            <span className="font-medium">04/04/2025</span>
                        </div>
                        <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-4">
                            <span className="text-gray-600 dark:text-gray-400">Moderador Responsável:</span>
                            <div className="flex items-center space-x-2">
                                <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=456" alt="Moderador" className="h-6 w-6 rounded-full" />
                    ...
                    <div className="timeline-item">
                        <div className="timeline-content">
                            <div className="flex items-center mb-4">
                                ...
                                <h3 className="text-lg font-semibold">Recebimento da Denúncia</h3>
                            </div>
                    ...
                    <div className="timeline-item">
                        <div className="timeline-content">
                            <div className="flex items-center mb-4">
                                ...
                                <h3 className="text-lg font-semibold">Análise das Evidências</h3>
                            </div>
                            <p className="text-gray-600 dark:text-gray-400">
                ...
                <div className="info-card">
                    ...
                    <div className="space-y-4">
                        <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">30 dias (até 04/05/2025)</p>
                        </div>
                        ...
                        <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Violação registrada permanentemente</p>
                        </div>
                        ...
                        <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Bloqueio permanente de interação com a vítima</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="info-card mt-8">
                    <h2 className="text-xl font-semibold mb-6">Obrigada por utilizar nosso serviço!</h2>
                    <p className="text-gray-600 dark:text-gray-400 mb-6">
                        Informamos que o processo foi encerrado com sucesso.
                        Caso tenha dúvidas ou precise de suporte adicional, falar com a diretoria da sua escola.
                    </p>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            ...
                            <p className="text-gray-400">Apoiando a defesa justa contra acusações de bullying.</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-gray-400">
                                <li><a href="index.html" className="hover:text-white">Tela de Início</a></li>
