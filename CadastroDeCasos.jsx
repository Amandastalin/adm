                    ...
                    <div className="p-6">
                        ...
                        <form className="space-y-6" id="caseForm">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">Nome Completo do Acusado</label>
                                    <input className="w-full border rounded-lg px-4 py-2" type="text" />
                                </div>
                                <div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-2">Descrição do Caso</label>
                            ...
                            <div>
                                ...
                                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                                    ...
                                    <button className="mt-2 text-blue-600 hover:text-blue-800 text-sm" onClick={() => document.getElementById('fileUpload').click()} type="button">
                                        Selecionar Arquivos
                                    </button>
                                </div>
                            </div>
                            <div className="flex justify-end space-x-4">
                                <button className="px-6 py-2 border rounded-lg hover:bg-gray-50" type="button">
                                    Cancelar
                                </button>
                                <button className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700" type="submit">
                                    Cadastrar Caso
                                </button>
                            </div>
                        </form>
                ...
                <section className="bg-white rounded-lg shadow" id="recent-submissions">
                    <div className="p-6">
                            ...
                            <table className="w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr className="border-t">
                                        ...
                                        <td className="px-4 py-3">
                                            <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm">Confirmado</span>
                                        </td>
                                        <td className="px-4 py-3">
                                            <div className="flex space-x-2">
                                                <button className="text-blue-600 hover:text-blue-800">
                        ...
                        <div className="flex justify-between items-center mt-6">
                            <p className="text-sm text-gray-500">Mostrando 2 de 50 resultados</p>
                            <div className="flex space-x-2">
                                <button className="px-3 py-1 border rounded-lg hover:bg-gray-50">Anterior</button>
                                ...
                                <button className="px-3 py-1 border rounded-lg hover:bg-gray-50">Próximo</button>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            ...
                            <p className="text-sm text-gray-400">Sistema de Administração e Fiscalização de Casos de Cyberbullying</p>
                        </div>
                        <div>
                            <h3 className="text-lg font-semibold mb-4">Contato</h3>
                            <p className="text-sm text-gray-400">
                                <i className="fa-solid fa-envelope mr-2"></i>contato@defensoria.gov.br
                            </p>
                            <p className="text-sm text-gray-400">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-400">
                                <i className="fa-solid fa-lock mr-2"></i>Todas as informações são sigilosas e protegidas por lei
                            </p>
                        </div>
                    </div>
