...
const AdminPage = () => {
    useEffect(() => {
        ...
        function filterList() {
            ...
            const filteredRows = acusadosRows.map(row => {
                const name = row.getAttribute('data-name').toLowerCase();
                const numero = row.getAttribute('data-process-number').toLowerCase();

                let prioridade = -1;

                if ((name.startsWith(nameTerm) && nameTerm) || (numero.startsWith(processTerm) && processTerm)) {
                    prioridade = 2;
                } else if ((name.includes(nameTerm) && nameTerm) || (numero.includes(processTerm) && processTerm)) {
                    prioridade = 1;
                }
                ...
                <section className="section hero-section">
                    <div className="container">
                        <div className="hero-content">
                            ...
                            <p className="hero-subtitle">Acesso Restrito da Defensoria Escolar.</p>
                        </div>
                    </div>
                </section>

                <div className="container mx-auto px-6 py-8">
                    <section id="dashboard-stats" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        <div className="bg-white rounded-lg shadow p-6">
                            <h2 className="text-lg font-semibold text-gray-700">Casos Recebidos</h2>
                            <p className="text-3xl font-bold text-blue-500">1,284
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            <h2 className="text-lg font-semibold text-gray-700">Defesas Cadastradas</h2>
                            <p className="text-3xl font-bold text-green-500">957
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            <h2 className="text-lg font-semibold text-gray-700">Em Análise</h2>
                            <p className="text-3xl font-bold text-yellow-500">327
                        ...
                        <div className="bg-white rounded-lg shadow p-6">
                            <h2 className="text-lg font-semibold text-gray-700">Concluídos</h2>
                            <p className="text-3xl font-bold text-emerald-500">630
                    ...
                    <section id="search-section" className="bg-white rounded-lg shadow mb-8 p-6">
                        <h2 className="text-xl font-semibold text-gray-700 mb-4">Busca Avançada</h2>
                        <form className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="search-container">
                                <i className="fa-solid fa-search search-icon"></i>
                                <input type="text" id="search-acusado" placeholder="Nome ou CPF" className="border border-gray-300 rounded px-4 py-2 w-full" />
                            </div>
                            <input type="text" id="search-process" placeholder="Nº do Processo" className="border border-gray-300 rounded px-4 py-2" />
                            <input type="text" placeholder="Palavra-chave" className="border border-gray-300 rounded px-4 py-2" />
                            <button type="submit" className="col-span-1 md:col-span-3 bg-blue-600 text-white rounded px-6 py-2 hover:bg-blue-700">Buscar</button>
                        </form>
                    </section>

                    <section id="cases-list" className="bg-white rounded-lg shadow p-6">
                        <h2 className="text-xl font-semibold text-gray-700 mb-4">Casos Recentes</h2>
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                ...
                                <tbody id="acusados-list">
                                    ...
                                    <tr className="border-t" data-name="Everton Vitor" data-process-number="123456789">
                                        <td className="px-4 py-3">Everton Vitor</td>
                                        <td className="px-4 py-3">123456789</td>
                                        <td className="px-4 py-3">15/03/2025</td>
                                        <td className="px-4 py-3">
                                            <span className="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm">Em Análise</span>
                                        </td>
                                        <td className="px-4 py-3">
                                            <button className="text-blue-600 hover:text-blue-800 view-details" data-id="everton-vitor">
                ...
                <div className="footer-container">
                    <div className="footer-content">
                        <div className="footer-column">
                            ...
                            <p className="footer-description">Apoiando a defesa justa contra acusações de bullying.</p>
                        </div>
                        <div className="footer-column">
                        ...
                        <div className="footer-column">
                            ...
                            <ul className="footer-contact">
                                <li>
                                    <img src="https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/12e3e5c0-7957-484a-9862-266b72810b4c" alt="Email icon" className="contact-icon" />
                                    <span>Email: support@cyberdefense.com</span>
                                </li>
                                <li>
                                    <img src="https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/6274e94d-2dba-412e-9de5-1484acf3cbb1" alt="Phone icon" className="contact-icon" />
